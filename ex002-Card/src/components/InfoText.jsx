...
export default () => {
    return (
        <p className={styles.infoText}>
            A nova ilustração de Star Wars: Episódio VII – O despertar da Força é simplesmente fantástica e consegue despertar todos os sentimentos de nostalgia que a franquia precisa.
